...
type Kernel_
    ...
    complex(r64),dimension(0:Jmax_max,-Jmax_max:Jmax_max,-Jmax_max:Jmax_max,2,2,2) :: Eccentricity_KK    ! Eccentricity_KK(J,Kf,Ki,it,Pi(+/-),1B/2B), <J_f K_f q_1 Pi| E_n |J_i K_i q_2 Pi> 
