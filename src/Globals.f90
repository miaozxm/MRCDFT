...
type Proj_Output_FileName
    ...
    ! R2-body kernel
    character(len=70) :: outputR2bodyKernel
    integer :: u_outputR2bodyKernel = u_config + 18
end type
...
type Kernel_
    ...
    complex(r64),dimension(0:Jmax_max,-Jmax_max:Jmax_max,-Jmax_max:Jmax_max,3,2,2) :: r2_2b_KK_byDensity ! 注释来源：AI 未核验 r2_2b_KK_byDensity(J,Kf,Ki,it,Pi_i(+/-)), <Ji+2 Kf q1 Pi_f ||r2||Ji Ki q2 Pi_i>
    complex(r64),dimension(0:Jmax_max,-Jmax_max:Jmax_max,-Jmax_max:Jmax_max,2,5,3) :: r2_2b_KK ! r2_2b_KK(J,Kf,Ki,it,Pi_i(+/-)), <Ji+2 Kf q1 Pi_f ||r2||Ji Ki q2 Pi_i>
    complex(r64),dimension(0:Jmax_max,-Jmax_max:Jmax_max,-Jmax_max:Jmax_max,2,5) :: Eccentricity_KK    ! Eccentricity_KK(J,Kf,Ki,Pi(+/-),1B/2B), <J_f K_f q_1 Pi| E_n |J_i K_i q_2 Pi> 
    complex(r64),dimension(0:Jmax_max,-Jmax_max:Jmax_max,-Jmax_max:Jmax_max,2,3) :: Ecc_sep_KK        ! Ecc_sep_KK(J,Kf,Ki,Pi(+/-),n1B/p1B/np2B), separated n/p/np contributions
