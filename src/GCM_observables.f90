...
MODULE GCM_Observables
    ...
    subroutine calculate_spectrum
        ...
        use Globals, only: HWG,gcm_space,GCM_kernels,constraint,GCM_obser,Proj_option,GCM_basis
        ...
        do J = gcm_space%Jmin, gcm_space%Jmax, gcm_space%Jstep
            ...
            do iM = 1, HWG%M(J,parity)
                ...
                do qK1 = 1, GCM_basis%N(J,parity)
                    ...
                    beta2_aver = beta2_aver + HWG%gJKq(qK1,iM,J,parity)**2*constraint%betac(q1)
                    beta3_aver = beta3_aver + HWG%gJKq(qK1,iM,J,parity)**2*constraint%bet3c(q1)
                    do qK2 = 1, GCM_basis%N(J,parity)
                        q2 = GCM_basis%basis(1,qK2,J,parity)
                        K2 = GCM_basis%basis(2,qK2,J,parity)
                        coef = HWG%fJKq(qK1,iM,J,parity)*HWG%fJKq(qK2,iM,J,parity)
                        ! BE2 or <r^2>
                ...
                GCM_obser%E_ex(iM,J,parity) = HWG%E(iM,J,parity) - HWG%E(1,0,1)
        ...
        subroutine printObservables
            ...
            do J = gcm_space%Jmin, gcm_space%Jmax, gcm_space%Jstep
                ...
                do iM = 1, HWG%M(J,parity)
                    write(*,format1) J,ParityChar(parity),iM,HWG%E(iM,J,parity),GCM_obser%E_ex(iM,J,parity),&
